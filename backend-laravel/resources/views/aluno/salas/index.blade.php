{{-- resources/views/aluno/salas/index.blade.php --}}
@extends('layouts.app')
...
<div class="teachers-grid">
    ...
    <div class="teacher-card">
        ...
        <div class="teacher-footer">
            @if($sala->status === 'active')
                <form action="{{ route('aluno.salas.join', $sala->id) }}" method="POST" style="flex:1">
                    @csrf
            ...
            @else
                <a href="{{ route('aluno.salas.show', $sala->id) }}"
                   class="btn-primary" style="flex:1;text-align:center">
                    <i class="fas fa-clock"></i> Ver Detalhes
                </a>
            @endif
            <a href="{{ route('aluno.salas.show', $sala->id) }}" class="btn-secondary">
                <i class="fas fa-info-circle"></i>
            </a>
        </div>
