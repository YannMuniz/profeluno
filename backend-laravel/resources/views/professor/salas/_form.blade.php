{{-- resources/views/professor/sala-criar.blade.php --}}
@extends('layouts.app')
...
<div class="page-header">
    <div class="page-header-left">
        <a href="{{ route('professor.sala.buscar') }}" class="back-link">
...
<form action="{{ route('professor.sala.store') }}" method="POST" enctype="multipart/form-data" id="formCriarSala">
    @csrf
    ...
    <div class="form-step active" id="step-1">
        ...
        <div class="form-actions">
            <a href="{{ route('professor.sala.buscar') }}" class="btn-form-cancel">
            ...
            <div class="form-card-body">
                ...
                <div class="material-toggle-row">
                    <label class="toggle-switch">
                        <input type="checkbox" id="addMaterial" name="add_material" value="1">
                        <span class="toggle-slider"></span>
                    </label>
                    <span>Adicionar material a esta sala</span>
                </div>

                <div id="materialFields" class="hidden-fields">
                    <div class="form-group">
                        <label class="form-label">Título do Material <span class="required">*</span></label>
                        <input type="text" name="material_titulo" class="form-control" placeholder="Ex: Apostila — Capítulo 3">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Descrição</label>
                        <textarea name="material_descricao" class="form-control" rows="3" placeholder="Descreva o material..."></textarea>
                    </div>

                    <div class="form-row-two">
                        <div class="form-group">
                            <label class="form-label">Tipo <span class="required">*</span></label>
                            <select name="material_type" class="form-control filter-select">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                <i class="fas fa-link"></i>
                                <input type="url" name="material_file_url" class="form-control" placeholder="https://...">
                            </div>
                        </div>
                    </div>
    ...
    <div class="form-step" id="step-3">
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="material-toggle-row">
                    <label class="toggle-switch">
                        <input type="checkbox" id="addSimulado" name="add_simulado" value="1">
                        <span class="toggle-slider"></span>
                    </label>
                    <span>Adicionar simulado a esta sala</span>
                </div>

                <div id="simuladoFields" class="hidden-fields">
