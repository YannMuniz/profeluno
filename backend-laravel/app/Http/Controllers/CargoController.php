...
class CargoController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            $response = Http::get("{$this->baseUrl}/v1/Materia/ListarCargos");
        ...
        try {
            ...
            if ($response->successful()) {
                return redirect()
                    ...
                    ->with('success', 'Cargo cadastradoq com sucesso!');
            }
    ...
    public function edit(string $id)
    {
        ...
        try {
            $response = Http::get("{$this->baseUrl}/v1/Cargo/BuscarCargoPorId/{$id}");
            // dd($response->json());

            if ($response->successful()) {
                $cargo = (object) $response->json();
            } else {
