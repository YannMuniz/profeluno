...
| C# API | 9000 | Externo | http://localhost:9000 |
| PostgreSQL | 5432 | Externo | localhost:5432 |
| **Interno (entre containers)** |  |  |  |
| Laravel → C# | N/A | Interno | http://dotnet:9000 |
...
DB_USERNAME=postgres
DB_PASSWORD=postgres
DOTNET_API_URL=http://dotnet:9000
```
...
- [ ] C# acessível em http://localhost:9000
